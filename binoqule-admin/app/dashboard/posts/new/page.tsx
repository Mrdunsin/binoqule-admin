  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="bg-white rounded-lg shadow p-6 space-y-6">
        <div>
          <label className="block text-sm font-semibold text-dark mb-2" style={{pointerEvents: "none"}}>Title *</label>
          <input id="post-title" type="text" placeholder="Enter post title..." className="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber outline-none" style={{position: "relative", zIndex: 2}} style={{position: "relative", zIndex: 2}} />
        </div>

        <div>
          <label className="block text-sm font-semibold text-dark mb-2" style={{pointerEvents: "none"}}>URL Slug</label>
        ...
        <div>
          <label className="block text-sm font-semibold text-dark mb-2" style={{pointerEvents: "none"}}>Deck / Subtitle</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-semibold text-dark mb-2" style={{pointerEvents: "none"}}>Author *</label>
            <select id="post-author" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber outline-none" style={{position: "relative", zIndex: 2}}>
              <option value="">Select author...</option>
              {authors.map(a => <option key={a.id} value={a.id}>{a.name}</option>)}
            </select>
          </div>
          <div>
            <label className="block text-sm font-semibold text-dark mb-2" style={{pointerEvents: "none"}}>Category *</label>
            <input id="post-category" type="text" placeholder="e.g., Policy Review" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber outline-none" style={{position: "relative", zIndex: 2}} />
          </div>
        </div>

        <div>
          <label className="block text-sm font-semibold text-dark mb-2" style={{pointerEvents: "none"}}>Cover Image URL</label>
          <input id="post-cover" type="url" placeholder="https://example.com/image.jpg" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber outline-none" style={{position: "relative", zIndex: 2}} />
        </div>

        <div>
          <label className="block text-sm font-semibold text-dark mb-2" style={{pointerEvents: "none"}}>Content *</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-semibold text-dark mb-2" style={{pointerEvents: "none"}}>Tags (comma-separated)</label>
            <input id="post-tags" type="text" placeholder="startup law, data protection" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber outline-none" style={{position: "relative", zIndex: 2}} />
          </div>
          <div>
            <label className="block text-sm font-semibold text-dark mb-2" style={{pointerEvents: "none"}}>Read Time (minutes)</label>
            <input id="post-readtime" type="number" defaultValue="5" min="1" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber outline-none" style={{position: "relative", zIndex: 2}} />
          </div>
        </div>
