...
export default function EditPostPage() {
  ...
  // Load post data and initialize Quill
  useEffect(() => {
    if (!postId) return
  ...
  const initQuill = (content: string) => {
    ...
    <>
      ...
      <div style={{ padding: '32px', maxWidth: '900px', fontFamily: 'Source Sans 3, sans-serif', color: '#2D2626' }}>
        ...
        <div style={{ display: 'grid', gap: '16px' }}>
          {/* Title */}
          <div>
            <label style={{ display: 'block', fontWeight: '600', marginBottom: '6px', pointerEvents: 'none' }}>
              Title *
            </label>
            <input
              id="edit-title"
          ...
          <div>
            ...
            <input
              id="edit-tags"
              type="text"
              placeholder="e.g. family law, contracts, property"
              style={inputStyle}
            />
          </div>
        ...
        <div style={{ display: 'flex', gap: '12px', marginTop: '24px', flexWrap: 'wrap' }}>
          ...
          <button
            ...
            style={{ ...buttonStyle, background: '#CC2827', marginLeft: 'auto' }}
          >
            Delete Post
          </button>
        </div>
