          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div style={{ position: 'relative' }}>
                <label className="block text-sm font-medium mb-2" style={{ pointerEvents: 'none' }}>Name *</label>
                <input id="edit-name" type="text" className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-amber outline-none" style={{ position: 'relative', zIndex: 2 }} />
              </div>
              <div style={{ position: 'relative' }}>
                <label className="block text-sm font-medium mb-2" style={{ pointerEvents: 'none' }}>Email *</label>
                <input id="edit-email" type="email" className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-amber outline-none" style={{ position: 'relative', zIndex: 2 }} />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div style={{ position: 'relative' }}>
                <label className="block text-sm font-medium mb-2" style={{ pointerEvents: 'none' }}>Role *</label>
                <input id="edit-role" type="text" className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-amber outline-none" style={{ position: 'relative', zIndex: 2 }} />
              </div>
              <div style={{ position: 'relative' }}>
                <label className="block text-sm font-medium mb-2" style={{ pointerEvents: 'none' }}>Focus Area</label>
                <input id="edit-focus" type="text" className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-amber outline-none" style={{ position: 'relative', zIndex: 2 }} />
              </div>
            </div>
            <div style={{ position: 'relative' }}>
              <label className="block text-sm font-medium mb-2" style={{ pointerEvents: 'none' }}>Photo URL</label>
              <input id="edit-photo" type="url" className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-amber outline-none" style={{ position: 'relative', zIndex: 2 }} />
            </div>
            <div style={{ position: 'relative' }}>
              <label className="block text-sm font-medium mb-2" style={{ pointerEvents: 'none' }}>Bio</label>
              <textarea id="edit-bio" rows={4} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-amber outline-none resize-none" style={{ position: 'relative', zIndex: 2 }} />
            </div>
            <div className="flex gap-3 pt-3 border-t" style={{ position: 'relative', zIndex: 2 }}>
              <button onClick={handleSave} className="flex items-center gap-2 bg-amber hover:bg-red text-white px-6 py-3 rounded-lg" style={{ cursor: 'pointer', position: 'relative', zIndex: 3 }}><Save size={18} />Save</button>
              <button onClick={() => setEditingId(null)} className="flex items-center gap-2 bg-gray-200 hover:bg-gray-300 text-gray-700 px-6 py-3 rounded-lg" style={{ cursor: 'pointer', position: 'relative', zIndex: 3 }}><X size={18} />Cancel</button>
            </div>
          </div>
        </div>
      )}
